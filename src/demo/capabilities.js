...
const CORE_CAPABILITIES = Object.freeze([
  {
    ...
    roles: ['agent', 'brokerage', 'seller', 'buyer', 'bank', 'developer', 'notary', 'landRegistry', 'vmls'],
    mode: 'interactive',
    page: 'cong-viec',
    iconName: 'document',
  },
  ...
  },
  {
    id: 'notary-dossiers',
    group: 'Công việc VMLS',
    name: 'Hồ sơ công chứng',
    description: 'Tiếp nhận thành phần hồ sơ, yêu cầu bổ sung và trả mã hợp đồng.',
    roles: ['notary'],
    mode: 'interactive',
    page: 'cong-chung',
    iconName: 'notary',
  ...
  },
  {
    ...
    group: 'Công việc VMLS',
    name: 'Đăng ký biến động',
    description: 'Xử lý hồ sơ đã định tuyến và trả kết quả đăng ký biến động.',
    roles: ['landRegistry'],
    mode: 'interactive',
    page: 'chuyen-quyen',
...
const CONNECTION_CAPABILITIES = Object.freeze([
  ...
  },
  {
    ...
    description: 'Nguồn tham chiếu công khai về nhà ở và thị trường bất động sản.',
    roles: ['agent', 'brokerage', 'developer', 'vmls'],
    mode: 'readOnly',
  ...
  },
  {
    ...
    roles: ['agent', 'seller', 'buyer', 'notary', 'vmls'],
    mode: 'eventOnly',
    iconName: 'notary',
