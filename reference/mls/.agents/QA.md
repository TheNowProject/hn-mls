...
- Cover `Incomplete`, `Incoming`, `Active`, and downstream visibility as distinct states or stages until the product model resolves them.
- Test public, member-only, and restricted fields across list, detail, search, export, report, logs, and partner feeds.
