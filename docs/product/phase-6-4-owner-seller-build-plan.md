...
1. Môi giới BĐS (`agent`)
2. Sàn môi giới (`broker`)
3. Chủ đầu tư dự án BĐS (`developer`)
4. Người mua (`buyer`)
5. Người bán / Chủ sở hữu BĐS (`seller`)
6. Ngân hàng (`bank`)

The role switcher keeps non-primary perspectives after those six:

7. Cơ quan quản lý (`regulator`) — deferred exploration
