...
- Mở workspace, chọn `Đặt lại dữ liệu`, xác nhận hộp thoại và kiểm tra cả hai Bất động sản là `Đã định danh`, đang chờ gửi thông tin đến Người bán; quay lại `/` trước khi bắt đầu quay.
...
| 03:05–08:40 | Workspace | Hoàn tất S2-12A từ nhập NPID và gửi thông tin đến Người bán đến HĐMB mới; ghé Sàn và Ngân hàng | Nêu rõ PLID tự tạo, PTID tự tạo, tuyến Chủ đầu tư và projection Ngân hàng đã được đồng ý chia sẻ. |
...
| 00:45–02:25 | S2-12A · Tổng quan và Quyền đại diện | Nhập `NPID-HN-09876`, phạm vi, ngày hiệu lực và ngày hết hạn; chọn `Gửi thông tin đến Người bán`, rồi kiểm tra hai khối Người bán và Người đại diện | NPID đã tồn tại được dùng trực tiếp, không có bước chọn candidate hay nguồn. Yêu cầu chứa đúng BĐS, hai bên, phạm vi và thời hạn; công việc chuyển sang Người bán. |
...
| 03:35–04:15 | Môi giới · S2-12A | Nhập mã định danh Người mua, giá thỏa thuận và ngày dự kiến ký; gửi `Ghi nhận Người mua` | Chủ sở hữu công việc chuyển sang Người mua. PTID vẫn chưa tồn tại. |
| 04:15–04:55 | Người mua · Hồ sơ mua | Kiểm tra họ tên, mã định danh Người mua, NPID, loại giao dịch, giá, ngày dự kiến ký; hoàn tất checklist và lựa chọn chia sẻ tài chính | Readiness thành `Đã sẵn sàng công chứng`. Hồ sơ xuất hiện trong hàng đợi VPCC. Nếu đã đồng ý chia sẻ, hồ sơ cũng xuất hiện ở Ngân hàng với đúng tập trường. |
...
| 06:10–06:50 | VPCC · S2-12A | Nhập mã hợp đồng và thời điểm ký; gửi `Ghi nhận kết quả ký` | Hợp đồng VPCC được lưu. `PTID-HN-00031` tự tạo; sự kiện thuế và định tuyến được nối; tuyến là Chủ đầu tư/HĐMB. |
...
| 09:20–10:35 | Môi giới rồi Người bán · Phú Thượng | Nhập `NPID-HN-10421`, gửi thông tin đại diện có thời hạn, rồi xác nhận ở vai Người bán | Không có bước khớp candidate. `PLID-HN-00208` tự tạo và hoàn toàn độc lập với S2-12A. |
...
| 12:55–13:40 | VPCC · Phú Thượng | Gửi mã hợp đồng và thời điểm ký | `PTID-HN-00044` tự tạo; tuyến là VPĐKĐĐ theo căn cứ Giấy chứng nhận. |
| 13:40–14:25 | VPĐKĐĐ · Đăng ký biến động | Nhập mã kết quả và thời điểm hiệu lực; gửi | BĐS và Giao dịch thành `Đã sang tên`; mã kết quả bên ngoài xuất hiện. |
...
| 10–20 | Định danh và nguồn | Nhập NPID đã có, xem NPID detail, khái niệm diện tích và source records chỉ đọc | Hệ thống nguồn nào cấp NPID và xử lý xung đột định danh trước bước này? |
